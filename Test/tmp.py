...
e=Employees(emp_no=-70, first_name='Burcin', last_name='Guenes',birth_date='2000-12-25', hire_date='2019-02-01',gender='F')
s=Salary(emp_no=-70,salary=10235,from_date='2019-01-02', to_date='9999-01-01')

session.add(s)
e.salary.append(s)
session.add(e)

de = Dept_emp(emp_no=-70, dept_no='d004', to_date='9999-01-01', from_date='2019-02-01')
session.add(de)
